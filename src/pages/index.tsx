  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine: Streamlining your dining experience with easy table reservations and efficient menu management, right at your fingertips."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine: Streamlining your dining experience with easy table reservations and efficient menu management, right at your fingertips.`}
            </Text>
            <Box
